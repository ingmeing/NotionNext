...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '趁现在，打开生活该有的样子,趁现在，打开生活健康的样子,趁现在，打开生活主动的样子,趁现在，打开生活未知的样子,Be Your Lifepartner🤗',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || true, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '码上觉醒', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '循证 健康 生活 陪伴', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.kdocs.cn/l/cvG20svlkmNw', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '健康,积极,生活,营养,循证,陪伴', // 网站关键词 英文逗号隔开
  ...
  FONT_URL: [
    ...
    'https://fonts.googleapis.com/css?family=Bitter&display=swap', //https://fonts.googleapis.cn/css?family=Bitter&display=swap
  ...
  // 所有支持的分享服务：link(复制链接),wechat(微信),qq,weibo(微博),email(邮件),facebook,twitter,telegram,messenger,line,reddit,whatsapp,linkedin,vkshare,okshare,tumblr,livejournal,mailru,viber,workplace,pocket,instapaper,hatena、、link,wechat,qq,weibo,email,facebook,twitter,telegram,messenger,line,reddit,whatsapp,linkedin
  ...
  NOTION_PROPERTY_NAME: {
    ...
    category: process.env.NEXT_PUBLIC_NOTION_PROPERTY_CATEGORY || '话题向',
